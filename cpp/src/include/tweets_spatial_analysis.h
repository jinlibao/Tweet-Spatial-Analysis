...
template <class T> void build_distance_matrix(string adj_file, string dis_file, int *argc, char ***argv);
template <class T> void test_APD_recursive(string mat_file, int mode, int *argc, char ***argv);
template <class T> void test_APD(string mat_file, int mode, int *argc, char ***argv);
