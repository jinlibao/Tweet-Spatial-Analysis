...
template <class T> void test_matrix_multiplication(int rows, int node, int n_procs, int mode = 0, string mat_A = "", string mat_B = "", string mat_C = "");
template <class T> void test_matrix_square(int rows, int node, int n_procs, int mode = 0, string mat_A = "", string mat_C = "");
