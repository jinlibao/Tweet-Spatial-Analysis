...
SUC_MATRIX[0]=$DATA_DIR/cpp_total/tweets_mean_all_successor_matrix.csv
SUC_MATRIX[1]=$DATA_DIR/cpp_total/tweets_median_working_successor_matrix.csv
SUC_MATRIX[2]=$DATA_DIR/cpp_total/tweets_median_non_working_successor_matrix.csv
 ...
 ADJ_ORDER[2]=$DATA_DIR/cpp_total/tweets_median_non_working_adjacency_matrix_ordered.csv
  ID_ORDER[0]=$DATA_DIR/cpp_total/tweets_mean_all_adjacency_matrix_ordered_id.csv
  ID_ORDER[1]=$DATA_DIR/cpp_total/tweets_median_working_adjacency_matrix_ordered_id.csv
  ID_ORDER[2]=$DATA_DIR/cpp_total/tweets_median_non_working_adjacency_matrix_ordered_id.csv
...
# ADJ_MATRIX[0]=$DATA_DIR/cpp_test/tweets_mean_all_adjacency_matrix.csv
# ADJ_MATRIX[1]=$DATA_DIR/cpp_test/tweets_median_working_adjacency_matrix.csv
# ADJ_MATRIX[2]=$DATA_DIR/cpp_test/tweets_median_non_working_adjacency_matrix.csv
# DIS_MATRIX[0]=$DATA_DIR/cpp_test/tweets_mean_all_distance_matrix.csv
# DIS_MATRIX[1]=$DATA_DIR/cpp_test/tweets_median_working_distance_matrix.csv
# DIS_MATRIX[2]=$DATA_DIR/cpp_test/tweets_median_non_working_distance_matrix.csv
# SUC_MATRIX[0]=$DATA_DIR/cpp_test/tweets_mean_all_successor_matrix.csv
# SUC_MATRIX[1]=$DATA_DIR/cpp_test/tweets_median_working_successor_matrix.csv
# SUC_MATRIX[2]=$DATA_DIR/cpp_test/tweets_median_non_working_successor_matrix.csv
#  ADJ_ORDER[0]=$DATA_DIR/cpp_test/tweets_mean_all_adjacency_matrix_ordered.csv
#  ADJ_ORDER[1]=$DATA_DIR/cpp_test/tweets_median_working_adjacency_matrix_ordered.csv
#  ADJ_ORDER[2]=$DATA_DIR/cpp_test/tweets_median_non_working_adjacency_matrix_ordered.csv
#   ID_ORDER[0]=$DATA_DIR/cpp_test/tweets_mean_all_adjacency_matrix_ordered_id.csv
#   ID_ORDER[1]=$DATA_DIR/cpp_test/tweets_median_working_adjacency_matrix_ordered_id.csv
#   ID_ORDER[2]=$DATA_DIR/cpp_test/tweets_median_non_working_adjacency_matrix_ordered_id.csv
#    OUTLIER[0]=$DATA_DIR/cpp_test/tweets_mean_all_outlier.csv
#    OUTLIER[1]=$DATA_DIR/cpp_test/tweets_median_working_outlier.csv
#    OUTLIER[2]=$DATA_DIR/cpp_test/tweets_median_non_working_outlier.csv
